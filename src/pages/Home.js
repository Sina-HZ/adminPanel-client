...
import { EmailRounded, FingerprintRounded, LayersRounded, WifiTetheringRounded } from "@material-ui/icons";
                        ...
                        <Paper elevation={0} className={classes.notifMain}>
                            {SimpleNotif.map((item, index) => (
                                <Box key={index} className={classes.notifItem}>
                                    <Typography variant='body1' style={{ fontWeight: 500 }} gutterBottom>{item.title}</Typography>
